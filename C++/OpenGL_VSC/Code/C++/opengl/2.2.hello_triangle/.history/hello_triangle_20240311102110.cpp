...
int main()
{
    ...
    if (!success)
    {
        glGetProgramiv(shaderProgram, GL_INFO_LOG_LENGTH, &shaderProgrameLogLength);
        std::vector<GLchar> programeLog(shaderProgrameLogLength);
        glGetProgramInfoLog(shaderProgram, shaderProgrameLogLength, nullptr, programeLog.data());
