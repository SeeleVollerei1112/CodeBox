...
int main()
{
    ...
    if (!success)
    {
        ...
        std::vector<GLchar> programLog(shaderProgramLogLength);
        glGetProgramInfoLog(shaderProgram, shaderProgramLogLength, nullptr, programLog.data());

        std::string shaderProgramLog(programLog.begin(), programLog.end());
